...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Young+Serif&pause=1000&color=8706E1FF&center=false&vCenter=true&random=false&width=435&lines=Welcome!+I'm+Sithum+Jayasinghe;Aspiring+Software+Engineer;Eager+to+Build+Real-World+Projects)](https://git.io/typing-svg)

---

<img height="200" align="center" src="https://github-readme-stats.vercel.app/api?username=Sithum-Jayasinghe&show_icons=true&theme=default&hide_title=true" />
...
**Languages:**  
`HTML` `CSS` `JavaScript` `PHP` `C` `C++` `Java` `Python`

**Frameworks & Libraries:**  
`React.js` `Node.js` `Express.js` `Bootstrap` `Tailwind CSS`

**Databases & Tools:**  
`MySQL` `MongoDB` `Git` `Linux (Ubuntu)` `REST API`

---

### 💼 Career Objective

I'm currently seeking a **Software Engineering internship** where I can:
- Apply my knowledge of full-stack web development
- Learn from real-world projects in a collaborative environment
- Contribute to building scalable and user-focused software solutions

> I'm especially passionate about deploying apps in **Linux-based environments**, using optimized server configurations for performance and security.

---

### 📈 GitHub Trophies

[![trophy](https://github-profile-trophy.vercel.app/?username=Sithum-Jayasinghe&margin-w=12&margin-h=12&theme=flat&column=6)](https://github.com/ryo-ma/github-profile-trophy)
...
> 🌟 *Thank you for visiting my GitHub profile. I'm always open to new opportunities, learning, and collaboration!*
